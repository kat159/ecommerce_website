...
export default defineConfig({
  ...
  //   {
  //     path: '/',
  //     component: '../layout/ECommerceFrontLayout',
  //   }
  // ],
  /**
   * @name 主题的配置
  ...
  openAPI: [
    ...
    //   // coupon service
    //   requestLibPath: "import { request } from '@umijs/max'",
    //   schemaPath: "http://localhost:7000/v3/api-docs/",
    //   projectName: 'ecommerce-dbms-coupon-service',
    //   mock: false,
    // },
    // {
    //   // member service
    ...
    //   // warehouse service
    //   requestLibPath: "import { request } from '@umijs/max'",
    //   schemaPath: "http://localhost:11000/v3/api-docs/",
    //   projectName: 'ecommerce-dbms-warehouse-service',
    //   mock: false,
    // },
  ],
  mfsu: {
