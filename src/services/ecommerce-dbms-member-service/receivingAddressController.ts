...
export async function update(body: API.ReceivingAddressDto, options?: { [key: string]: any }) {
...
export async function save(body: API.ReceivingAddressDto, options?: { [key: string]: any }) {
  return request<API.Result>('/member/receivingaddress', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
