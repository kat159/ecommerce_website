...
export async function update(body: API.FavoriteProductDto, options?: { [key: string]: any }) {
...
export async function save(body: API.FavoriteProductDto, options?: { [key: string]: any }) {
  return request<API.Result>('/member/favoriteproduct', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
