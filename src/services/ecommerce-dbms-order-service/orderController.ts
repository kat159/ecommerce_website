...
/** 此处后端没有提供注释 PUT /order/order */
export async function update(body: API.OrderDto, options?: { [key: string]: any }) {
...
export async function get(
  ...
  return request<API.Result>(`/order/order/${param0}`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  });
...
export async function page(
  ...
  return request<API.Result>('/order/order/page', {
    method: 'GET',
    params: {
      ...params,
      params: undefined,
