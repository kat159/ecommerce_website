...
export async function update(body: API.CategoryBrandDto, options?: { [key: string]: any }) {
...
export async function save(body: API.CategoryBrandDto, options?: { [key: string]: any }) {
  return request<API.Result>('/product/categorybrand', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
