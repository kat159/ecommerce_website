...
export async function update(body: API.ProductDescriptionDto, options?: { [key: string]: any }) {
...
export async function save(body: API.ProductDescriptionDto, options?: { [key: string]: any }) {
  return request<API.Result>('/product/productdescription', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
