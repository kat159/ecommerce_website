...
export async function update(body: API.ProductAttrbuteValueDto, options?: { [key: string]: any }) {
...
export async function save(body: API.ProductAttrbuteValueDto, options?: { [key: string]: any }) {
  return request<API.Result>('/product/productattrbutevalue', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
